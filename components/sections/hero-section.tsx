    ...
    <section className="min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-20 relative">
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto">
        ...
        <h1 className="font-display font-bold tracking-tight mb-6">
          <span className="text-zinc-100 text-5xl md:text-7xl block">Cursor for LaTex</span>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col items-start">
              <div className="flex items-center gap-1">
                ...
                <span className="text-zinc-400 font-medium ml-1 text-sm">
                  5.0
                </span>
              </div>
              <p className="text-sm text-zinc-500">
                Trusted by{" "}
                <span className="text-zinc-300 font-medium">10,000+</span> job
                seekers & researchers
              </p>
            </div>
          </div>
