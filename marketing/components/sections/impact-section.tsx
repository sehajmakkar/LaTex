const metrics = [
  { value: "10K+", label: "Resumes Created", description: "And counting" },
  { value: "3x", label: "Faster Writing", description: "With inline AI" },
  { value: "92%", label: "Avg ATS Score", description: "Across all users" },
  { value: "40%", label: "More Interviews", description: "Reported by users" },
];
